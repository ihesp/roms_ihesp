...
set oinfile = "${input_data_dir}/${st_year}${st_mon}${st_day}${st_hr}/ocean.in"
...
if (($OCN_GRID == gom3)||($OCN_GRID == gom3x)) then
     ...
     ln -sf ${input_data_dir}/${st_year}${st_mon}${st_day}${st_hr}/*.nc ${RUNDIR} || exit -2 
endif
...
#    cp -f ${input_data_dir}/gom03_xroms_sstice.nc ${RUNDIR}    # already linked
    cp -f ${input_data_dir}/${st_year}${st_mon}${st_day}${st_hr}/docn.streams.txt.prescribed ${RUNDIR}
...
#    cp -f $CODEROOT/${ocn_dir}/Apps/${OCN_GRID}/docn_ocn_in ${RUNDIR}/docn_ocn_in${INST_STR}
    cp -f  ${input_data_dir}/${st_year}${st_mon}${st_day}${st_hr}/docn_ocn_in ${RUNDIR}/docn_ocn_in${INST_STR}
